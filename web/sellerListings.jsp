											...
											<td class="px-8 py-6 text-right">
												<c:if test="${product.status == 'AVAILABLE'}">
													<div class="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
														...
														<a href="removeProduct.jsp?id=${product.productId}" class="w-10 h-10 rounded-xl bg-white border border-gray-100 flex items-center justify-center text-gray-400 hover:text-red-500 hover:shadow-lg transition-all">
