                                                        ...
                                                        <a href="messages" class="relative p-3 rounded-xl hover:bg-gray-50 transition-all text-gray-500 hover:text-primary">
                                                            ...
                                                            <c:if test="${unreadMsgCount gt 0}">
                                                                <span class="absolute -top-1 -right-1 w-5 h-5 bg-primary text-white text-[10px] font-black rounded-full flex items-center justify-center">
                                                                    <c:choose>
                                                                        <c:when test="${unreadMsgCount gt 9}">9+</c:when>
                                                                        <c:otherwise>${unreadMsgCount}</c:otherwise>
                                                                    </c:choose>
                                                                </span>
                                                            </c:if>
