							...
							<div class="space-y-4 pt-4">
								<c:choose>
									...
									<c:when test="${not empty sessionScope.userId}">
										...
										<a href="messages?with=${product.sellerId}" class="flex items-center justify-center w-full bg-white text-gray-900 border-2 border-gray-100 py-5 rounded-2xl font-bold hover:bg-gray-50 transition-all">
