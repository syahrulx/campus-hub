...
<div class="bg-transparent min-h-screen pt-24 pb-20">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Profile error (request attribute) OR password error (query param) -->
        <c:if test="${not empty error or not empty param.pwError}">
            <div class="mb-8 bg-red-50 border-l-4 border-red-500 p-4 rounded-r-xl animate-in fade-in slide-in-from-top-4 duration-500">
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-red-700 font-bold italic">
                            <c:out value="${not empty error ? error : param.pwError}" />
                        </p>
                    </div>
                </div>
            </div>
        ...
        <!-- Password success (query param) -->
        <c:if test="${not empty param.pwSuccess}">
            <div class="mb-8 bg-green-50 border-l-4 border-green-500 p-4 rounded-r-xl animate-in fade-in slide-in-from-top-4 duration-500">
                <div class="flex">
                    <div class="flex-shrink-0">
                        <svg class="h-5 w-5 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                        <path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.707a1 1 0 00-1.414-1.414L9 10.172 7.121 8.293a1 1 0 10-1.414 1.414l2.586 2.586a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path>
                        </svg>
                    </div>
                    <div class="ml-3">
                        <p class="text-sm text-green-800 font-bold italic">
                            <c:out value="${param.pwSuccess}" />
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-10 sm:p-12">
                <form action="editProfile" method="POST" class="space-y-8">
                    <div class="space-y-6">
                        <!-- Name -->
                        <div>
                            <label class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] block mb-2 px-1">
                        ...
                        <div>
                            ...
                            <p class="text-[9px] font-black text-gray-300 uppercase tracking-widest mt-2 px-1 italic">
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <select name="university"
                                        class="w-full appearance-none bg-gray-50 border-2 border-gray-50 focus:border-primary px-14 py-4 rounded-2xl font-bold text-gray-900 transition-all focus:outline-none focus:ring-4 focus:ring-primary/5 cursor-pointer">
                    ...
                    <div class="pt-6 flex flex-col sm:flex-row gap-4 justify-end">
                        <a href="profile"
                           class="px-10 py-4 bg-gray-50 text-gray-900 rounded-2xl font-black text-xs uppercase tracking-widest border border-gray-100 hover:bg-white hover:shadow-lg transition-all text-center">
                            Cancel
                        </a>
                        <button type="submit"
                                class="px-12 py-4 bg-primary text-white rounded-2xl font-black text-xs uppercase tracking-widest shadow-lg shadow-red-900/10 hover:shadow-primary/20 transition-all transform active:scale-95 flex items-center justify-center gap-2 group">
        ...
        <!-- 2) Password Card -->
        <div class="mt-8 bg-white rounded-[3rem] shadow-sm border border-gray-100 overflow-hidden">
            <div class="p-10 sm:p-12">
                <div class="mb-8">
                    <h2 class="text-xl font-black text-gray-900 tracking-tight italic uppercase">Password</h2>
                    <p class="text-xs text-gray-400 font-medium uppercase tracking-widest mt-2">Update your credentials</p>
                </div>

                <form action="resetPassword" method="POST" class="space-y-8">
                    ...
                    <div class="space-y-6">
                                ...
                                <span class="absolute inset-y-0 left-0 pl-6 flex items-center text-gray-400 group-focus-within:text-primary transition-colors">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                              d="M12 15v2m6-6V9a6 6 0 10-12 0v2m-1 0h14a2 2 0 012 2v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4a2 2 0 012-2z"></path>
                                    </svg>
                                </span>
                        ...
                        <div>
                            ...
                            <div class="relative group">
                                ...
                                <input type="password" name="newPassword" required placeholder="At least 8 characters"
                                       class="w-full bg-gray-50 border-2 border-gray-50 focus:border-primary px-14 py-4 rounded-2xl font-bold text-gray-900 transition-all focus:outline-none focus:ring-4 focus:ring-primary/5">
                            </div>
                            <p class="text-[9px] font-black text-gray-300 uppercase tracking-widest mt-2 px-1 italic">
