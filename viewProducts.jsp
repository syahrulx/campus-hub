		...
		<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
										...
										<form action="cart" method="POST">
											...
											<button type="submit" class="p-2.5 bg-gray-900 text-white rounded-xl hover:bg-primary transition-colors active:scale-95 group/btn">
												<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z"></path></svg>
                                                                                ...
                                                                                <a href="messages?with=${product.sellerId}&about=${product.productId}"
											<button type="submit" class="p-2.5 bg-gray-900 text-white rounded-xl hover:bg-primary transition-colors active:scale-95 group/btn">
			...
			<c:if test="${empty featuredProducts}">
				<div class="py-32 text-center">
					...
					<h3 class="text-xl font-black text-gray-900 italic uppercase tracking-tight mb-2">No Listing Yet!</h3>
					<p class="text-[10px] font-black text-gray-400 uppercase tracking-widest italic mb-8">Start listing your items for other to buy.</p>
					<a href="addProduct" class="px-8 py-4 bg-gray-900 text-white rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-primary transition-colors inline-block">
						Sell New Item
					</a>
				</div>
			</c:if>
